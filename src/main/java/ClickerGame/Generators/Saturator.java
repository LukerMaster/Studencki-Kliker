...
public class Saturator implements IGenerator, IScrappable, IMadeOutOf {

    final IInventory inventory;

    final Map<ItemId, BigInteger> itemsNecessary = Map.of(
            ItemId.Potato, new BigInteger("80"),
            ItemId.Meat, new BigInteger("10"),
            ItemId.Beer, new BigInteger("5"));

    final IScrappable scrappingComponent;
    final Map<ItemId, BigInteger> itemsSpawned = Map.of(ItemId.Vodka, new BigInteger("1"));
    ...
    public Map<ItemId, BigInteger> GetWhatItsMadeOutOf() {
        return Map.of(ItemId.Metal, new BigInteger("25"),
